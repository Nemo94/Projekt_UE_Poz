...
void StepperDriverInit(uint8_t stepper_id)
{
	...
	switch(stepper_id)
	{
		...
		case 3:
		STEPPERX_DIR_PORT = STEPPER3_DIR_PORT;
		STEPPERX_DIR_PIN = STEPPER3_DIR_PIN;
		STEPPERX_STEP_PORT = STEPPER3_STEP_PORT;
		STEPPERX_STEP_PIN = STEPPER3_STEP_PIN;
		STEPPERX_EN_PORT = STEPPER3_EN_PORT;
		STEPPERX_EN_PIN = STEPPER3_EN_PIN;
		break;
		
		case 4:
		STEPPERX_DIR_PORT = STEPPER4_DIR_PORT;
		STEPPERX_DIR_PIN = STEPPER4_DIR_PIN;
		STEPPERX_STEP_PORT = STEPPER4_STEP_PORT;
		STEPPERX_STEP_PIN = STEPPER4_STEP_PIN;
		STEPPERX_EN_PORT = STEPPER4_EN_PORT;
		STEPPERX_EN_PIN = STEPPER4_EN_PIN;
		break;
